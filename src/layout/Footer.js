...
const Footer1 = () => (
  <footer className="main-footer footer-two pt-30 bgc-lighter">
      ...
      <div className="row justify-content-xl-between justify-content-center">
        <div className="col-xl-4 col-lg-5 col-md-6">
          <div className="footer-widget widget_about me-md-5 wow fadeInUp delay-0-2s">
            <div className="footer-logo mb-25">
              <Link href="/">
                <a>
                  <img src="/assets/images/metalearn/logo.png" alt="Logo" />
                </a>
              </Link>
            </div>
            {/* <p>
            ...
            <ul>
              <li>Gmail: info@3i.com.vn</li>
              <li>Mua hàng (+84) 0904322883</li>
              <li>Tuyển dụng (+84) 0904322883</li>
              <li>
              ...
              <li>
                Số 23-25 Trần Nhật Duật , Phường Tân Định , Quận 1 , Tp Hồ chí
                Minh
              </li>
            </ul>
        ...
        <div className="col-xl-4 col-md-6">
          <div className="footer-widget widget_nav_menu wow fadeInUp delay-0-4s">
            ...
            <ul className="list-style-two">
              ...
              <li>
                <a href="/blog">Tài liệu môn học</a>
              </li>
              <li>
                <Link href="/service-details">Khóa học</Link>
              </li>
            </ul>
          </div>
        </div>
        <div className="col-xl-4 col-lg-6 col-md-8">
          <div className="footer-widget widget_newsletter wow fadeInUp delay-0-6s">
            ...
            <p>Đăng ký để nhận được nhiều hơn mỗi bản cập nhật</p>
    ...
    <div className="footer-bottom  pt-25 pb-10">
      <div className="container">
        <div className="copyright-text text-center">
          <p>© Copyright 2022 3I. All right reserved</p>
        </div>
      </div>
    </div>
  </footer>
        ...
        <div className="col-xl-4 col-lg-6 col-md-8">
          <div className="footer-widget widget_newsletter wow fadeInUp delay-0-6s">
            ...
            <form onSubmit={(e) => e.preventDefault()} action="#">
              <input type="email" placeholder="Email" required="" />
              <button className="theme-btn">
                Đăng ký ngay <i className="fas fa-angle-double-right" />
              </button>
            </form>
          </div>
        </div>
